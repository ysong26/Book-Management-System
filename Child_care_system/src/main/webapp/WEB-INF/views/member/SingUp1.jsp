...
1. 수집하는 개인정보
이용자는 회원가입을 하지 않으면 서비스를 이용할 수 없습니다. 이용자가 서비스를 이용하기 위해 회원가입을 할 경우, VITA500은 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.
회원가입 시점에 VITA500이 이용자로부터 수집하는 개인정보는 아래와 같습니다.
...
제 1 조 (목적)
이 약관은 VITA500 주식회사 (이하 “회사”)가 제공하는 위치정보사업 또는 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.
...
상호: VITA500 FACTORY
주소: 경기도 수원시 권선구 덕영대로1201번길 28 금강타운 4층 VITA500 FACTORY
전화번호: 031-224-3636
Fax:031-224-3626 
이메일 주소: VIDA500@VITA.com
부칙
제1조 시행일
